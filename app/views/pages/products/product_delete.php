            ...
            <div id="profile-data" class="card-body">
                <form method="POST" id="form-machine-category" autocomplete="off">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" readonly class="form-control-plaintext"  value="<?php echo $row['product_description'] ?>">
                      </div>
                    </div>  


                    <div class="form-group ">
                        <button id="" name="delete_product" type="submit" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                            <i class="fas fa-user-plus fa-sm text-white-50"></i>&nbsp;&nbsp;Delete Product
                        </button>
                    </div>
