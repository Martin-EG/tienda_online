...
if (isset($inventory)) {
  if ($inventory->errors) {
      foreach ($inventory->errors as $error) {
        echo "
  ...
  if ($inventory->messages) {
      foreach ($inventory->messages as $message) {
        echo "
        <script type='text/javascript'>
          document.addEventListener('DOMContentLoaded', function(event) {
            swal('$message');
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <h6 class="m-0 font-weight-bold text-default">Product</h6>
    ...
    <div class="col-lg-8">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <h6 class="m-0 font-weight-bold text-default">Register a loss</h6>
            ...
            <div id="profile-data" class="card-body">
                <form method="POST" id="form-machine-category" autocomplete="off">
                    ...
                    <span class="d-block p-2 bg-dark text-white">Loss</span>

                    <br>

                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-3 col-form-label">Loss Quantity</label>
                      <div class="col-sm-9">
                        <input type="number" step=".01" name="loss_qty"  class="form-control" >
                      </div>
                    </div>

                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-3 col-form-label">Reason For Loss</label>
                      <div class="col-sm-9">
                        <textarea  name="loss_note"  class="form-control" ></textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group ">
                        <button id="" name="loss_product" type="submit" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                            <i class="fas fa-user-plus fa-sm text-white-50"></i>&nbsp;&nbsp;Register Product Loss
                        </button>
                    </div>
