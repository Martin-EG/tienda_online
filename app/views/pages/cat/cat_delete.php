            ...
            <div id="profile-data" class="card-body">
                <form method="POST" id="form-machine-category" autocomplete="off">
                    <div class="form-group">
                        ...
                        <input  type="text" name="cat_name" id="" disabled class="form-control" value="<?php if(isset($row['cat_name'])){echo $row['cat_name'];}else{echo "";} ?>" required>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <button id="edit_profile1" name="delete_cat" type="submit" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                            <i class="fas fa-user-plus fa-sm text-white-50"></i>&nbsp;&nbsp;Delete Category
                        </button>
                    </div>
