...
$data[] = array( 
    ...
    "product_actions"=> "
    <a href='index.php?page=inventory_purchase&product={$row['product_id']}' class=''  data-cat-name='{$row['product_name']}' data-cat-id='{$row['product_id']}' ><i data-toggle='tooltip' data-placement='left' title='Edit category' style='font-size: 20px; color:#70e000' class='fas fa-angle-double-up options'></i></a>
    &nbsp;&nbsp;
    <a href='index.php?page=inventory_loss&product={$row['product_id']}'  class=''  data-cat-name='{$row['product_name']}' data-cat-id='{$row['product_id']}'><i data-toggle='tooltip' data-placement='left' title='Edit category' style='font-size: 20px; color:#ff4524' class='fas fa-angle-double-down options'></i></a>"
);
}
