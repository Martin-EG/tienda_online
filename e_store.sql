...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2020 at 07:37 AM
...
CREATE TABLE `orders` (
  ...
  `order_number_products` int(11) NOT NULL,
  `order_client_name` varchar(255) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `order_client_lname` varchar(255) COLLATE utf8mb4_spanish2_ci NOT NULL,
  ...
  `order_currency_price` varchar(3) COLLATE utf8mb4_spanish2_ci NOT NULL,
...
INSERT INTO `orders` (`order_id`, `order_number_products`, `order_client_name`, `order_client_lname`, `order_client_email`, `order_client_phone`, `order_client_address`, `order_total_price`, `order_currency_price`, `order_client_notes`, `order_date`, `order_status`, `order_sent_date`) VALUES
(1, 4, 'Martin', 'Espericueta Gomez', 'martin.m.espericueta@gmail.com', '6863509426', 'Av. Duque de Florencia Oeste #316', 40, 'USD', '', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),
(2, 4, 'Martin', 'Espericueta Gomez', 'martin.m.espericueta@gmail.com', '6863509426', 'Av. Duque de Florencia Oeste #316', 40, 'USD', '', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00');
...
(6, 'image test 33', 'description', 1, 1, 'uploads/products/noimage.png', 2, 1000, 1);
